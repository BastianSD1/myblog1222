...
function ordenar() {
 ...
 console. log (longitud_nombre_alumnos_array);
  for (var k = 0; k < longitud_nombre_alumnos_array; k++) {
    ver ver_alumno_array_ordenar.push("<h4>NOMBRE - "+ nombre_alumno_array[k]+</h4>");
    console.log(ver_alumno_array_ordenar);
    var remover_comas 0= ver_alumno_array_ordenar.join(" ");
    console.log(remover_comas);
    document.ger getElementById("ver_nombre_sin_comas ").innerHTML=remover_comas;

}

function actualizar() {
    document.ger getElementById("ver_nombre_sin_comas ").innerHTML= "<h1>"+nombre_alumno_array + "</h1>"  ;    
}
